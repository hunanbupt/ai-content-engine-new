    ...
    <div class="container">
      <a-spin :spinning="loading" tip="加载中...">
        <a-card :bordered="false" v-if="article" class="article-card">
          ...
          <!-- 封面图 -->
          <div v-if="article.coverImage && article.fullContent" class="cover-image-section">
            <img :src="article.coverImage" :alt="article.mainTitle" class="cover-image" />
          </div>
...
const exportMarkdown = () => {
  ...
  if (article.value.fullContent) {
    if (article.value.coverImage) {
      markdown += `![封面图](${article.value.coverImage})\n\n`
    }
